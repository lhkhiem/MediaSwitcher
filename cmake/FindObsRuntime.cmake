...
if (NOT EXISTS "${OBS_RUNTIME_PLUGIN_BIN_DIR}/obs-transitions.dll")
    message(FATAL_ERROR "OBS runtime ${OBS_REQUIRED_VERSION} is missing required transition module '${OBS_RUNTIME_PLUGIN_BIN_DIR}/obs-transitions.dll'.")
endif()
if (NOT EXISTS "${OBS_RUNTIME_PLUGIN_BIN_DIR}/image-source.dll")
    message(FATAL_ERROR "OBS runtime ${OBS_REQUIRED_VERSION} is missing required image module '${OBS_RUNTIME_PLUGIN_BIN_DIR}/image-source.dll'.")
endif()
...
if (NOT EXISTS "${OBS_RUNTIME_PLUGIN_DATA_DIR}/obs-transitions/fade_transition.effect")
    message(FATAL_ERROR "OBS runtime ${OBS_REQUIRED_VERSION} is missing required fade effect '${OBS_RUNTIME_PLUGIN_DATA_DIR}/obs-transitions/fade_transition.effect'.")
endif()
if (NOT IS_DIRECTORY "${OBS_RUNTIME_PLUGIN_DATA_DIR}/image-source")
    message(FATAL_ERROR "OBS runtime ${OBS_REQUIRED_VERSION} is missing required image module data '${OBS_RUNTIME_PLUGIN_DATA_DIR}/image-source'.")
endif()
...
message(STATUS "MediaSwitcher OBS modules: obs-ffmpeg, obs-transitions, image-source; graphics backend: libobs-d3d11")
